...
import { deleteNoteById, fileterNotesByLastNumberDays, filterNotesByContent } from '../../library/services/NotesService';
...
export const SearchScreen = () => {
  ...
  useEffect(()=>{
    ...
    if(route.params.indexDate >= 0)
        filterByDate(route.params.indexDate);
  }, [])
